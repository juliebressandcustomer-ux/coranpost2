...
DEFAULT_CONFIG = {
    ...
    "line_spacing": 1.5,
    "max_width_percent": 85,  # % de la largeur pour le texte
...
def get_font(font_path, size):
    ...
    try:
        ...
        # Si rien trouvé, utiliser la police par défaut
        print(f"⚠️ Police {font_path} introuvable, utilisation de la police par défaut")
...
def generate_duaa_image(duaa_text, config, output_path):
    ...
    try:
        ...
        # Nettoyer et reshape le texte arabe
        duaa_text = clean_arabic_text(duaa_text)
        duaa_text = reshape_arabic_text(duaa_text)
